                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center'>
                    ...
                    <div className='flex flex-col animate-fade-in-up' style={{ animationDelay: '0.1s' }}>
                        ...
                        <div className="mb-6">
                            ...
                            <h2 className="uppercase text-[32px] sm:text-[40px] md:text-[48px] lg:text-[40px] xl:text-[48px] encode-sans-medium leading-none mt-2 animate-f-up bg-clip-text text-transparent"
                                style={{
                                    backgroundImage: 'linear-gradient(98.52deg, #040404 10.39%, #7A7A7A 93.32%)',
                                    animationDelay: '0.2s'
                                }}>
                        ...
                        <div className="mb-10">
                            <p className="description text-gray-500 leading-relaxed max-w-none">
                                Our commitment to excellence is reflected in every packet. Through strict adherence to global safety standards and continuous monitoring, we ensure that Mr Chilli products remain the gold standard of purity and flavor.
                            </p>
                        </div>
